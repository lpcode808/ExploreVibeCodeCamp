# Vibe Code Camp Explorer

Interactive tools for exploring Every's 8-hour Vibe Code Camp livestream featuring 20 speakers on AI-assisted development.

**[View Live Site](https://lpcode808.github.io/ExploreVibeCodeCamp/)**
...
| `⌘K` | Search |
| `←` `→` | Navigate slides |
| `Esc` | Exit slideshow/close modal |
...
Based on [Every's Vibe Code Camp](https://www.youtube.com/watch?v=5YBjll9XJlw) livestream. Original transcript from [EveryInc/vibe-code-camp](https://github.com/EveryInc/vibe-code-camp).
